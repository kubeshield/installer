...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeshield.dev/installer/apis/installer/v1alpha1.ServiceMonitorLabels": schema_installer_apis_installer_v1alpha1_ServiceMonitorLabels(ref),
		"kubeshield.dev/installer/apis/installer/v1alpha1.ServingCerts":         schema_installer_apis_installer_v1alpha1_ServingCerts(ref),
		"kubeshield.dev/installer/apis/installer/v1alpha1.WebHookSpec":          schema_installer_apis_installer_v1alpha1_WebHookSpec(ref),
	}
}
...
func schema_installer_apis_installer_v1alpha1_IdentityServer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeshield.dev/installer/apis/installer/v1alpha1.IdentityServerSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeshield.dev/installer/apis/installer/v1alpha1.IdentityServerSpec"},
	}
}

func schema_installer_apis_installer_v1alpha1_IdentityServerList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IdentityServerList is a list of IdentityServers",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of IdentityServer CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kubeshield.dev/installer/apis/installer/v1alpha1.IdentityServer"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeshield.dev/installer/apis/installer/v1alpha1.IdentityServer"},
	}
}

func schema_installer_apis_installer_v1alpha1_IdentityServerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"apiserver": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeshield.dev/installer/apis/installer/v1alpha1.WebHookSpec"),
						},
					},
					"enableAnalytics": {
						SchemaProps: spec.SchemaProps{
...
func schema_installer_apis_installer_v1alpha1_Monitoring(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"prometheus": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeshield.dev/installer/apis/installer/v1alpha1.PrometheusSpec"),
						},
					},
					"serviceMonitor": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeshield.dev/installer/apis/installer/v1alpha1.ServiceMonitorLabels"),
						},
					},
				},
		...
		Dependencies: []string{
			"kubeshield.dev/installer/apis/installer/v1alpha1.PrometheusSpec", "kubeshield.dev/installer/apis/installer/v1alpha1.ServiceMonitorLabels"},
	}
}
...
func schema_installer_apis_installer_v1alpha1_WebHookSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"healthcheck": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeshield.dev/installer/apis/installer/v1alpha1.HealthcheckSpec"),
						},
					},
					"servingCerts": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeshield.dev/installer/apis/installer/v1alpha1.ServingCerts"),
						},
					},
				},
		...
		Dependencies: []string{
			"kubeshield.dev/installer/apis/installer/v1alpha1.HealthcheckSpec", "kubeshield.dev/installer/apis/installer/v1alpha1.ServingCerts"},
	}
}
